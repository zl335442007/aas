			...
			var _SELF = $(this),
				...
				object = function(length){
					...
					this.NumBtnDom = function(list,w,h,l,t){
						return "<dl style=\"z-index:11;width:"+(w + 72)+"px;height:"+h+"px;position:absolute;left:0;right:0; margin:0 auto; top:"+(t + 150)+"px;\">"+ list +"<dl>";
					};
					this.arrow = function(l,r,w,h,x,y){
						return "<em class=\"sPrev\" id=\"sPrev\" style=\"top:74px;position:absolute;cursor:pointer;z-index:10;width:"+(w+30)+"px;height:"+(h+6)+"px;left:"+(w-82)+"px;\"></em><em class=\"sNext\" id=\"sNext\" style=\"right:16px;position:absolute;cursor:pointer;z-index:10;width:"+(w + 35)+"px;height:"+(h+6)+"px;top:"+(y+73)+"px;\"></em>";
					};
					
//					this.arrowbottom = function(l,r,w,h,x,y){
//						return "<em class=\"sPrev jiantouxiaoico\" id=\"sPrev\" style=\"bottom: 13px; position: absolute; z-index: 555; cursor: pointer; width: 6px; height: 11px; left: 430px;\"></em><em class=\"sNext jiantouxiaoico\" id=\"sNext\" style=\"z-index: 555; right: 430px; position: absolute; cursor: pointer; width: 6px; height: 11px; bottom: 13px;\"></em>";
//					};
			...
			object.prototype.Initial = function(callback){
				...
				for(a=0;a<this.length;a++){
					...
					if(options.NumBtn){
						...
						if(this.centerIdx === a){
							sTmpDD = "<dd class=\"curr\" style=\""+ NumStyle +"\">"+ (a+1) +"</dd>";
						} else {
							sTmpDD = "<dd style=\""+ NumStyle +"\">"+ (a+1) +"</dd>";
						};
...
//				_SELF.prepend(this.arrowbottom(wrapL,wrapR,options.arrowbottom.width,options.arrowbottom.height,options.arrowbottom.x,options.arrowbottom.y))
//					 .find("em")
//					 .show(0); 
